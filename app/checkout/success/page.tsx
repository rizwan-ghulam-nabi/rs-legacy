        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          ...
          >
            ...
            {orderNumber && (
              <div className="bg-gray-50 rounded-xl p-6 mb-8">
                ...
                <p className="text-sm text-gray-500 mt-2">
                  📧 Two email notifications sent to admin
                </p>
              </div>
            )}
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link
                href="/OrderDetails"
                className="bg-gradient-to-r from-purple-600 to-blue-600 text-white px-8 py-3 rounded-xl font-semibold hover:shadow-lg transition-all flex items-center justify-center gap-2"
              >
                <Package className="w-5 h-5" />
                View Orders
              </Link>
              <Link
                href="/Product"
                className="bg-white text-purple-600 px-8 py-3 rounded-xl font-semibold border-2 border-purple-200 hover:bg-purple-50 transition-all flex items-center justify-center gap-2"
              >
                <ShoppingBag className="w-5 h-5" />
                Continue Shopping
              </Link>
